...
<body>
	<div class="container">
		<div class="well">
			<div class="pull-left">
				Hoşgeldiniz, <b>Onur KARACA</b> <a href="<?php echo base_url('auth/cikis'); ?>"><img src="../public/assets/temalar/cuzdan/images/logout.png" width="32" height="32"></a>
	...
	<label>Filtrele</label></div>
			...
			<div class="col-md-2">
			<td>	<input type="text" id="bitis" name="bitis" class="form-control" placeholder="Bitiş YYYY-MM-DD" value="<?php echo $bitisTarihi; ?>" />
			</div>		
			<div class="clear"></div>
		...
		<div class="well">
			...
			<div class="col-md-6">
				...
				<form class="form" action="<?php echo base_url('cuzdan/paraHareketiEkle'); ?>" method="post">
					...
					<input type="submit" value="gelir ekle" class="btn btn-block btn-primary" />
				</form>	
